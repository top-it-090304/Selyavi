...
var _steps = [
	...
	{"text": "Каждый снаряд уникален. Используй каждый под свою ситуацию.", "node": "AmmoPanel", "shape": 1},
	...
	{"text": "Миссия ясна. Уничтожь вражеские штабы и защити свой. Удачи в бою!", "node": "MarkerOverlay"}
]
